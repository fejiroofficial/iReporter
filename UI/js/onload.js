...
window.onload = () => {
    ...
    if (jwtDecoded) {
        ...
        const userdpTwo = document.getElementById('user-prof-dp');
        userdpTwo.style.background = `url(${defaultImage}) no-repeat center center`;
        userdpTwo.style.backgroundSize = 'contain';
        document.getElementById('profile-page-fullname').innerHTML = `${firstname} ${lastname}`;
        document.getElementById('profile-page-email').innerHTML = email;
        document.getElementById('profile-page-telephone').innerHTML = telephone;
    }
};
