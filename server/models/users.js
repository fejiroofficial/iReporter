...
export default class User {
  ...
  */
  ...
  create(values) {
    ...
    const sql = 'INSERT INTO users(firstname, lastname, email, username, password, isAdmin) VAlUES( ${firstname}, ${lastname}, ${email}, ${username}, ${password}, ${isAdmin}) RETURNING id, firstname, lastname, email, username, isAdmin, registered';
